...
現在、`離散数学` タブはプレースホルダーです。調整中の離散数学ページは `future_index.html` に置いています。メインページ下部には、目立たない `追加ページ` リンクがあります。
...
`future_index.html` はデバッグ中・調整中の追加ページ一覧です。ページ下部には、目立たない `メイン一覧へ戻る` リンクがあります。
